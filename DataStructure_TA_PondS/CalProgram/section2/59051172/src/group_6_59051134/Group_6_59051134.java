package group_6_59051134;
import java.io.*;
import java.util.Stack;
import java.util.*;
import java.util.Scanner;
public class Group_6_59051134 {
    public static void main(String[] args)
    {
        ...
        StringBuilder postfix = new StringBuilder(infix.length()); //สร้าง string เก็บ postfix
        ...
        Stack<Float> num = new Stack<>(); //สร้าง stack เก็บตัวเลข
        ...
        {   //เช็ค string ว่าเป็นเครื่องหมายหรือไม่
            ...
            {   //ถ้าไม่ใช่ให้เก็บตัวเชลขไว้ใน stack
